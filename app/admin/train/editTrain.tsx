...
const EditTrain = ({ selectedTrain }: { selectedTrain: Train }) => {
    ...
    const handleSubmit = async (e: FormEvent) => {
        ...
        try {
            ...
            if (data?.status) {
                toast(data?.message, { containerId: "toastTrain", type: "success", hideProgressBar: true })
                if (file) {
                ...
                toast(data?.message || "Failed to update train", { containerId: "toastTrain", type: "warning", hideProgressBar: true })
            }
        } catch (err) {
            console.error(err)
            toast("Something went wrong", { containerId: "toastTrain", type: "error", hideProgressBar: true })
        }
    }
    ...
    const handleChangePicture = async () => {
        ...
        try {
            ...
            console.log(error)
            toast(`Failed to update picture`, { hideProgressBar: true, containerId: `toastTrain`, type: `error` })
        }
    }
